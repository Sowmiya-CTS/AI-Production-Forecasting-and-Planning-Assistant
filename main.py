...
async def serve_frontend():
    ...
    # Path to the frontend folder in the same directory as main.py
...
async def create_forecast(
        ...
        product_id: str = Form(None, description="Product ID for the forecast."),
        product_name: str = Form(None, description="Product name for the forecast."),
        location: str = Form(None, description="Location for the forecast.")
):
    """
